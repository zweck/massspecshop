                    ...
                    <div class="media-frame wp-core-ui hide-router hide-toolbar">
                        ...
                        <div class="media-frame-menu">
                            <div class="media-menu">
                                <a id="gmedia-modal-terms" class="media-menu-item active" target="gmedia_frame" href="<?php echo add_query_arg( array(
                                                                                                                                                 'post_id'    => $post->ID,
                                                                                                                                                 'tab'        => 'gmedia_terms',
                                                                                                                                                 'chromeless' => true
                                                                                                                                         ), admin_url( 'media-upload.php' ) ); ?>"><?php _e( 'Gmedia Collections', 'grand-media' ); ?></a>
                                <a id="gmedia-modal-library" class="media-menu-item" target="gmedia_frame" href="<?php echo add_query_arg( array(
                                                                                                                                                   'post_id'    => $post->ID,
                                                                                                                                                   'tab'        => 'gmedia_library',
                                                                                                                                                   'chromeless' => true
                                                                                                                                           ), admin_url( 'media-upload.php' ) ); ?>"><?php _e( 'Gmedia Library', 'grand-media' ); ?></a>
                                <a id="gmedia-modal-galleries" class="media-menu-item" target="gmedia_frame" href="<?php echo add_query_arg( array(
                                                                                                                                                            'post_id'    => $post->ID,
                                ...
                                <?php if ( current_user_can( 'gmedia_upload' ) ) { ?>
                                    <a id="gmedia-modal-upload" class="media-menu-item" target="gmedia_frame" href="<?php echo add_query_arg( array(
                                                                                                                                                      'post_id'    => $post->ID,
                                                                                                                                                      'tab'        => 'gmedia_library',
                                                                                                                                                      'action'     => 'upload',
                                                                                                                                                      'chromeless' => true
                        ...
                        <div class="media-frame-content">
                            <div class="media-iframe">
                                <iframe name="gmedia_frame" src="<?php echo add_query_arg( array(
                                                                                                   'post_id'    => $post->ID,
                                                                                                   'tab'        => 'gmedia_terms',
                                                                                                   'chromeless' => true
