...
function twentytwelve_scripts_styles() {
	...
	wp_enqueue_script( 'bootstrap.min', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '20160517', true );
	...
	wp_enqueue_style( 'twentytwelve-fw', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css', array( 'twentytwelve-style' ), '20161011' );

	wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.css', array( 'twentytwelve-style' ), '20160517' );

wp_enqueue_style( 'flexslider', get_template_directory_uri() . '/css/flexslider.css', array( 'twentytwelve-style' ), '20160527' );
...
register_sidebar( array(
		...
		'name' => __( 'Footer menu1', 'twentytwelve' ),
	...
	register_sidebar( array(
		...
		'name' => __( 'Footer menu2', 'twentytwelve' ),
